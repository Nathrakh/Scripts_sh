...
\
Run the CMD aboove to view the themes then run the script > search for theme name > select number > enter. This script will auto-apply theme changes to (CONFIG_FILE="$HOME/.config/ghostty/config.ghostty")
\
